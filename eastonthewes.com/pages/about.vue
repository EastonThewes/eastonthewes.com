<template>
    <div class="flex pt-16 bg-secondary height">
        ...
        <AboutPagePicture filename="_nuxt/assets/images/eastontree.jpg" />
    </div>

    <div class="flex pt-32 pb-32 bg-secondary height">
        <AboutPagePicture filename="_nuxt/assets/images/easton.jpeg" />
...
<script>
    import AboutPagePicture from '../components/AboutPagePicture.vue'
    export default {
        components: {
            AboutPagePicture
        },
